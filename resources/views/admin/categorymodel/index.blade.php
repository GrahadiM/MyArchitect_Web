        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">Tabel Kategori Model
                            <div class="card-action">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('category-model.create') }}">Tambah Kategori</a>
                            ...
                            <table class="table table-hover align-items-center table-flush table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <form action="{{ route('category-model.destroy', $item->id) }}" method="POST">
                                                    <a href="{{ route('category-model.edit', $item->id) }}" class="mr-2 btn btn-dark btn-sm">edit</a>
                                                    @csrf
                                                    @method('DELETE')
