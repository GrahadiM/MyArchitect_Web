        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">Tabel Arsitek
                        ...
                        <div class="col-12 col-lg-12 justify-content-center mt-3">
                            <ul class="list-inline">
                                <li class="list-inline-item ml-3">
                                    <p class="text-center">
                                        Halaman : {{ $arsiteks->currentPage() }}
                                    </p>
                                </li>
                                <li class="list-inline-item ml-3">
                                    <p class="text-center">
                                        Jumlah Data : {{ $arsiteks->total() }}
                                    </p>
                                </li>
                                <li class="list-inline-item ml-3">
                                    <p class="text-center">
                                        Data Per Halaman : {{ $arsiteks->perPage() }}
                                    </p>
                                </li>
                            </ul>
                            <p class="text-center">
                                <a class="mr-5" href="{{ $arsiteks->previousPageUrl() }}"><i class="zmdi zmdi-long-arrow-left"></i></a>
                                <a class="mr-5" href="{{ $arsiteks->nextPageUrl() }}"><i class="zmdi zmdi-long-arrow-right"></i></a>
                            </p>
                        </div>
                    </div>
                </div>
